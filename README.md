...
Aplicar: Executar comandos SQL para manipulação de dados. 

Aplicação: Uso de ferramentas reais (MySQL Workbench/PGAdmin). 

Criar: Desenvolver scripts SQL completos e bem estruturados. 

Integração: Combinar modelagem lógica e integridade com DML. 
...
livraria_saber_**schema_full**.sql 

Script completo de criação do DB e tabelas. 

Contém todos os CREATE TABLE e INSERT iniciais. 

livraria_saber_**autor**.sql 

CREATE TABLE e INSERT para a tabela autor. 

 

livraria_saber_**cliente**.sql 

CREATE TABLE e INSERT para a tabela cliente. 

 

livraria_saber_**editora**.sql 

CREATE TABLE e INSERT para a tabela editora. 

 

livraria_saber_**fornecedor**.sql 

CREATE TABLE e INSERT para a tabela fornecedor. 

 

livraria_saber_**livro**.sql 

CREATE TABLE e INSERT para a tabela livro. 

 

livraria_saber_**papelaria**.sql 

CREATE TABLE e INSERT para a tabela papelaria. 

 

livraria_saber_**vendedor**.sql 

CREATE TABLE e INSERT para a tabela vendedor. 

Necessário criar/incluir. 

livraria_saber_**venda**.sql 

CREATE TABLE e INSERT para a tabela venda. 

Depende de cliente e vendedor. 

livraria_saber_**item_venda**.sql 

CREATE TABLE e INSERT para a tabela item_venda. 

Depende de venda, livro e papelaria. 

livraria_saber_**dml_exemplos**.sql 

Script de manipulação de dados (DML). 

Contém SELECT, UPDATE e DELETE solicitados. 
